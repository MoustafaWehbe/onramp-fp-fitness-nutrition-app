  ...
  <section className="relative isolate flex min-h-screen w-full items-end overflow-hidden">
    ...
    <div className="mx-auto w-full max-w-7xl px-6 pb-8 pt-28 sm:pb-10 sm:pt-32 min-[2100px]:pb-16">
      <div className="max-w-xl animate-fade-up sm:max-w-2xl">
        ...
        <Link
          to={ROUTES.register}
          className="group mt-7 inline-flex items-center justify-center gap-2 rounded-xl bg-brand-green px-7 py-4 font-heading text-sm font-semibold uppercase tracking-wide text-[#0c2410] transition-colors hover:bg-white sm:mt-8"
        >
          Get started free
