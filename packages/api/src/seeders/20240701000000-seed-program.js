...
module.exports = {
  async up(queryInterface) {
    ...
    // ── 3. Day plans ──────────────────────────────────────────────────────────
    const days = [
      { day: 1, label: "Monday",    date: "2025-06-16", isRestDay: false },
      { day: 2, label: "Tuesday",   date: "2025-06-17", isRestDay: false },
      { day: 3, label: "Wednesday", date: "2025-06-18", isRestDay: false },
      { day: 4, label: "Thursday",  date: "2025-06-19", isRestDay: true  },
      { day: 5, label: "Friday",    date: "2025-06-20", isRestDay: false },
      { day: 6, label: "Saturday",  date: "2025-06-21", isRestDay: false },
      { day: 7, label: "Sunday",    date: "2025-06-22", isRestDay: true  },
    ];
